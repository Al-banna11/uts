...
<head>
    ...
    <title>Elite Estates| Payment</title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mb-2 mb-lg-0">
          ...
          <li class="nav-item me-3">
            <a class="nav-link  active  text-success" href="cart.php">Cart
          ...
          <span class="payment-text" > <strong>Payment</strong> </span>
            <div class="col-md-5 border border-1 rounded py-4 px-4">
                        ...
                        <?php while ($row = $showTotPri->fetch_assoc()) { ?>
                            <div style="height: 100%;"
                                ...
                                <div class="main">
                                    ...
                                    <p style="font-size: 13px;" class="mt-0 text-end text-muted">IDR
                                        <?= $row['price'] ?>
                                    </p>
                                </div>
                            </div>
                ...
                <?php while ($row = $total->fetch_assoc()) { ?>
                    <div class="d-flex flex-row justify-content-between">
                        <p class="text-muted" style="font-size: 13px;">IDR
                            <?= $row['total_price'] ?>
                        </p>
                        <p>Total</p>
                    </div>
               ...
               <button class="btn btn-success w-100 paymen" type="submit" id="success" name="pay"  onclick="showSweetAlert()">Buy</button>
...
<!-- Memuat Bootstrap JS (Opsional, tergantung kebutuhan Anda) -->
...
function showSweetAlert() {
    ...
    swal({
        ...
        dangerMode: false,
        timer: 25000, // Durasi dalam milidetik (15 detik)
    });
}
</script>
